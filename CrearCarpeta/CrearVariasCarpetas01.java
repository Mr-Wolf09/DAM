...
public class CrearVariasCarpetas01 {
	 					...
	 					do {
	 						...
	 						switch(opcion) {
	 									...
	 									case "B":
	 										 ...
	 										 System.out.println("Estas seguro de borrar esta carpeta: Y / N");
	 										  String borrar=Z.next();
	 										 File borrarCarpeta= new File(ruta+nombreCarpetaBorrar);
	 										 
	 										if (borrar.equals("y") || borrar.equals("Y")) {
	 										 ...
	 										 if(borrarCarpeta.exists()) {
	 											 ...
	 											 System.out.println("No se borra la carpeta");
	 										 }
	 										 }
	 										 break;
